...
export const metadata = {
  title: "Expenditcher | Payment Modes",
  ...
  return (
    <main className='flex flex-col items-center justify-center w-full h-full gap-14'>
      ...
      <div className='w-full mt-4'>
        <h2 className='text-xl text-center underline capitalize lg:text-2xl underline-offset-8'>Manage Payment Modes ({paymentModes?.total})</h2>
      </div>
      <div className='relative flex items-center w-full gap-4 overflow-x-auto h-96'>
        <AddPaymentMode owner_id={session?.user?._id} />
        {paymentModes?.total === 0 ? <div className='flex-none w-full lg:w-1/2 h-3/4 '>
      ...
      paymentModes?.result?.map((p_m,index) => (
