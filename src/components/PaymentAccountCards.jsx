...
const PaymentAccountCards = ({ p_m_name, pm_id }) => {
  return (
    ...
    <h2 className='flex items-center justify-center w-1/2 h-12'>
     <Link href={`/expenses/${pm_id}`} className='w-full py-3 tracking-wide text-center text-white uppercase transition-all duration-300 rounded-xl bg-slate-700 hover:bg-slate-600'>View</Link>
    </h2>
     </div>
